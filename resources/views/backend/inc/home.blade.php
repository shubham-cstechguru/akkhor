                ...
                <form method="POST" action="{{ route('admin.home.post') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input required type="text" name="slider_title" class="form-control name" id="slider_title" aria-describedby="slider_titleeHelp" placeholder="Enter Site Name" value="{{ $home['slider_title'] }}">
                        </div>
                        <div class="form-group col-md-6">
